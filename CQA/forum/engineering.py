def engineer(data):
    ...
    print("Simple features calculated")
    ...
    # FUZZ WUZZ Features
    print("Calculating Fuzzy Wuzzy features")
    ...
    data['fuzz_token_sort_ratio'] = data.apply(
        ...
        axis=1)
    print("Fuzzy Wuzzy Featuress Calculated")
    data['wmd'] = data.apply(lambda x: wmd(x['question1'], x['question2']), axis=1)

    question1_vectors = np.zeros((data.shape[0], 300))
    error_count = 0
    print("Translating questions into vectors")
